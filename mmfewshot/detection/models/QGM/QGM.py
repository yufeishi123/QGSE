...
from ..builder import QGM


@QGM.register_module()
class QGMModule(BaseModule):
    ...
    def __init__(self,
                 ...
                 bn_layer=True,
                 init_cfg=None):
        super(QGMModule, self).__init__(init_cfg)
    ...
    def forward_single(self, x, kv_x):
        ...
        sum_f = torch.sum(f, dim=2)

        mask = self.mlp_layer(sum_f).view(-1, 14, 14).unsqueeze(1)
